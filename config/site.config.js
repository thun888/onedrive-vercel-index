...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'thun888@qq.com',
  ...
  protectedRoutes: ['/文件', '/MC/我的世界存档备份'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:thun888@qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/thun888',
    },
    {
      name: 'Home',
      link: 'https://www.hzchu.top',
    },
  ],
